...
### TODO:
# Implement the math myself to speed up (get rid of edge cases and whatnot)
...
def randobit(uint64_t n_bits):  
    ...
    if rem_bytes:
        r = _next64() >> ((~(n_bits - 1)) & 63)
        memcpy(buf + (n_words << 3), &r, rem_bytes)
...
cdef double _gauss(): # box-muller transform
    ...
    next_gauss = u2 * sin(u1)
    return u2 * cos(u1)

#*#**#*#*#*#*#*#*#*#*#*#*#* Global Variables #*#**#*#*#*#*#*#*#*#*#*#*#*

cdef test_gauss(uint64_t n):
    cdef double _min = 1e9
...
#*#**#*#*#*#*#*#*#*#*#*#*#* MATH #*#**#*#*#*#*#*#*#*#*#*#*#*
# -2.0 * log(x); for 0 < x <= 1
# sin(2pi*x) and cos(2pi*x), for 0 < x <= 1
# The cmath implementations will have a lot of extra code for edge cases,
# rounding (ew), and all that other stuff that this fast rng stuff won't 
# need. 
